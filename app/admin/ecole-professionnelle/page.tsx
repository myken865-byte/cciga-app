  ...
  return (
    <div>
      <div className="mb-2 flex items-center gap-3">
        <SectorLogo sector="PROFESSIONNELLE" className="h-10 w-10 object-contain" />
        <h1 className="text-2xl font-bold text-foreground">Structure académique — École Professionnelle</h1>
      </div>
